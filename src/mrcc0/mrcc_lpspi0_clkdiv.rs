#[doc = "Register `MRCC_LPSPI0_CLKDIV` reader"]
pub type R = crate::R<MrccLpspi0ClkdivSpec>;
#[doc = "Register `MRCC_LPSPI0_CLKDIV` writer"]
pub type W = crate::W<MrccLpspi0ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccLpspi0ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccLpspi0ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccLpspi0ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccLpspi0ClkdivSpec;
impl crate::RegisterSpec for MrccLpspi0ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpspi0_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccLpspi0ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpspi0_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccLpspi0ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPSPI0_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccLpspi0ClkdivSpec {
