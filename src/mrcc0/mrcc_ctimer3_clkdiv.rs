#[doc = "Register `MRCC_CTIMER3_CLKDIV` reader"]
pub type R = crate::R<MrccCtimer3ClkdivSpec>;
#[doc = "Register `MRCC_CTIMER3_CLKDIV` writer"]
pub type W = crate::W<MrccCtimer3ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccCtimer3ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccCtimer3ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccCtimer3ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccCtimer3ClkdivSpec;
impl crate::RegisterSpec for MrccCtimer3ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_ctimer3_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccCtimer3ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_ctimer3_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccCtimer3ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CTIMER3_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccCtimer3ClkdivSpec {
