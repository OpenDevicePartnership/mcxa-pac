#[doc = "Register `MRCC_CMP2_RR_CLKDIV` reader"]
pub type R = crate::R<MrccCmp2RrClkdivSpec>;
#[doc = "Register `MRCC_CMP2_RR_CLKDIV` writer"]
pub type W = crate::W<MrccCmp2RrClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccCmp2RrClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccCmp2RrClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccCmp2RrClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccCmp2RrClkdivSpec;
impl crate::RegisterSpec for MrccCmp2RrClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_cmp2_rr_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccCmp2RrClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_cmp2_rr_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccCmp2RrClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CMP2_RR_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccCmp2RrClkdivSpec {
