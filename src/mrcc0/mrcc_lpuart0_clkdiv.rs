#[doc = "Register `MRCC_LPUART0_CLKDIV` reader"]
pub type R = crate::R<MrccLpuart0ClkdivSpec>;
#[doc = "Register `MRCC_LPUART0_CLKDIV` writer"]
pub type W = crate::W<MrccLpuart0ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccLpuart0ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccLpuart0ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccLpuart0ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccLpuart0ClkdivSpec;
impl crate::RegisterSpec for MrccLpuart0ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpuart0_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccLpuart0ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpuart0_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccLpuart0ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPUART0_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccLpuart0ClkdivSpec {
