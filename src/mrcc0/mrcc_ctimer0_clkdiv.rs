#[doc = "Register `MRCC_CTIMER0_CLKDIV` reader"]
pub type R = crate::R<MrccCtimer0ClkdivSpec>;
#[doc = "Register `MRCC_CTIMER0_CLKDIV` writer"]
pub type W = crate::W<MrccCtimer0ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccCtimer0ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccCtimer0ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccCtimer0ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccCtimer0ClkdivSpec;
impl crate::RegisterSpec for MrccCtimer0ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_ctimer0_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccCtimer0ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_ctimer0_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccCtimer0ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CTIMER0_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccCtimer0ClkdivSpec {
