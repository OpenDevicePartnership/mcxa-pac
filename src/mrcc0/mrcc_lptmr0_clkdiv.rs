#[doc = "Register `MRCC_LPTMR0_CLKDIV` reader"]
pub type R = crate::R<MrccLptmr0ClkdivSpec>;
#[doc = "Register `MRCC_LPTMR0_CLKDIV` writer"]
pub type W = crate::W<MrccLptmr0ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccLptmr0ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccLptmr0ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccLptmr0ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccLptmr0ClkdivSpec;
impl crate::RegisterSpec for MrccLptmr0ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lptmr0_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccLptmr0ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lptmr0_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccLptmr0ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPTMR0_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccLptmr0ClkdivSpec {
