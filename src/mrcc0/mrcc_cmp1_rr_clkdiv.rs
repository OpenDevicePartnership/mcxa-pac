#[doc = "Register `MRCC_CMP1_RR_CLKDIV` reader"]
pub type R = crate::R<MrccCmp1RrClkdivSpec>;
#[doc = "Register `MRCC_CMP1_RR_CLKDIV` writer"]
pub type W = crate::W<MrccCmp1RrClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccCmp1RrClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccCmp1RrClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccCmp1RrClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccCmp1RrClkdivSpec;
impl crate::RegisterSpec for MrccCmp1RrClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_cmp1_rr_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccCmp1RrClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_cmp1_rr_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccCmp1RrClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CMP1_RR_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccCmp1RrClkdivSpec {
