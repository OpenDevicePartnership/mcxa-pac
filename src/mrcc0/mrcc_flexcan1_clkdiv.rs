#[doc = "Register `MRCC_FLEXCAN1_CLKDIV` reader"]
pub type R = crate::R<MrccFlexcan1ClkdivSpec>;
#[doc = "Register `MRCC_FLEXCAN1_CLKDIV` writer"]
pub type W = crate::W<MrccFlexcan1ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccFlexcan1ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccFlexcan1ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccFlexcan1ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccFlexcan1ClkdivSpec;
impl crate::RegisterSpec for MrccFlexcan1ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_flexcan1_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccFlexcan1ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_flexcan1_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccFlexcan1ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_FLEXCAN1_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccFlexcan1ClkdivSpec {
