#[doc = "Register `MRCC_I3C0_FCLK_CLKDIV` reader"]
pub type R = crate::R<MrccI3c0FclkClkdivSpec>;
#[doc = "Register `MRCC_I3C0_FCLK_CLKDIV` writer"]
pub type W = crate::W<MrccI3c0FclkClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccI3c0FclkClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccI3c0FclkClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccI3c0FclkClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccI3c0FclkClkdivSpec;
impl crate::RegisterSpec for MrccI3c0FclkClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_i3c0_fclk_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccI3c0FclkClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_i3c0_fclk_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccI3c0FclkClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_I3C0_FCLK_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccI3c0FclkClkdivSpec {
