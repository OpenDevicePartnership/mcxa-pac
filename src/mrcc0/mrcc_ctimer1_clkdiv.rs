#[doc = "Register `MRCC_CTIMER1_CLKDIV` reader"]
pub type R = crate::R<MrccCtimer1ClkdivSpec>;
#[doc = "Register `MRCC_CTIMER1_CLKDIV` writer"]
pub type W = crate::W<MrccCtimer1ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccCtimer1ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccCtimer1ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccCtimer1ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccCtimer1ClkdivSpec;
impl crate::RegisterSpec for MrccCtimer1ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_ctimer1_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccCtimer1ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_ctimer1_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccCtimer1ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CTIMER1_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccCtimer1ClkdivSpec {
