#[doc = "Register `MRCC_ADC_CLKDIV` reader"]
pub type R = crate::R<MrccAdcClkdivSpec>;
#[doc = "Register `MRCC_ADC_CLKDIV` writer"]
pub type W = crate::W<MrccAdcClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccAdcClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccAdcClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccAdcClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccAdcClkdivSpec;
impl crate::RegisterSpec for MrccAdcClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_adc_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccAdcClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_adc_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccAdcClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_ADC_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccAdcClkdivSpec {
