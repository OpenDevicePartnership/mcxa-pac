#[doc = "Register `MRCC_CMP0_FUNC_CLKDIV` reader"]
pub type R = crate::R<MrccCmp0FuncClkdivSpec>;
#[doc = "Register `MRCC_CMP0_FUNC_CLKDIV` writer"]
pub type W = crate::W<MrccCmp0FuncClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccCmp0FuncClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccCmp0FuncClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccCmp0FuncClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccCmp0FuncClkdivSpec;
impl crate::RegisterSpec for MrccCmp0FuncClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_cmp0_func_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccCmp0FuncClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_cmp0_func_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccCmp0FuncClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CMP0_FUNC_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccCmp0FuncClkdivSpec {
