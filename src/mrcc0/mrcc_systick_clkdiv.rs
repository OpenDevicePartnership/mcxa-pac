#[doc = "Register `MRCC_SYSTICK_CLKDIV` reader"]
pub type R = crate::R<MrccSystickClkdivSpec>;
#[doc = "Register `MRCC_SYSTICK_CLKDIV` writer"]
pub type W = crate::W<MrccSystickClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccSystickClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccSystickClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccSystickClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccSystickClkdivSpec;
impl crate::RegisterSpec for MrccSystickClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_systick_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccSystickClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_systick_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccSystickClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_SYSTICK_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccSystickClkdivSpec {
