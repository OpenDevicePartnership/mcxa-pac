#[doc = "Register `MRCC_DBG_TRACE_CLKDIV` reader"]
pub type R = crate::R<MrccDbgTraceClkdivSpec>;
#[doc = "Register `MRCC_DBG_TRACE_CLKDIV` writer"]
pub type W = crate::W<MrccDbgTraceClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccDbgTraceClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccDbgTraceClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccDbgTraceClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccDbgTraceClkdivSpec;
impl crate::RegisterSpec for MrccDbgTraceClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_dbg_trace_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccDbgTraceClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_dbg_trace_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccDbgTraceClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_DBG_TRACE_CLKDIV to value 0"]
impl crate::Resettable for MrccDbgTraceClkdivSpec {}
