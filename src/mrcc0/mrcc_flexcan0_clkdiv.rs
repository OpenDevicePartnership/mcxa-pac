#[doc = "Register `MRCC_FLEXCAN0_CLKDIV` reader"]
pub type R = crate::R<MrccFlexcan0ClkdivSpec>;
#[doc = "Register `MRCC_FLEXCAN0_CLKDIV` writer"]
pub type W = crate::W<MrccFlexcan0ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccFlexcan0ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccFlexcan0ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccFlexcan0ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccFlexcan0ClkdivSpec;
impl crate::RegisterSpec for MrccFlexcan0ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_flexcan0_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccFlexcan0ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_flexcan0_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccFlexcan0ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_FLEXCAN0_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccFlexcan0ClkdivSpec {
