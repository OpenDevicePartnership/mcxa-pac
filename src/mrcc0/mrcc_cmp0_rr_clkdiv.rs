#[doc = "Register `MRCC_CMP0_RR_CLKDIV` reader"]
pub type R = crate::R<MrccCmp0RrClkdivSpec>;
#[doc = "Register `MRCC_CMP0_RR_CLKDIV` writer"]
pub type W = crate::W<MrccCmp0RrClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccCmp0RrClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccCmp0RrClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccCmp0RrClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccCmp0RrClkdivSpec;
impl crate::RegisterSpec for MrccCmp0RrClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_cmp0_rr_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccCmp0RrClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_cmp0_rr_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccCmp0RrClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CMP0_RR_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccCmp0RrClkdivSpec {
