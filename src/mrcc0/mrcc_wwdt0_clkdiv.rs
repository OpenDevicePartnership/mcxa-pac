#[doc = "Register `MRCC_WWDT0_CLKDIV` reader"]
pub type R = crate::R<MrccWwdt0ClkdivSpec>;
#[doc = "Register `MRCC_WWDT0_CLKDIV` writer"]
pub type W = crate::W<MrccWwdt0ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccWwdt0ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccWwdt0ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccWwdt0ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccWwdt0ClkdivSpec;
impl crate::RegisterSpec for MrccWwdt0ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_wwdt0_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccWwdt0ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_wwdt0_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccWwdt0ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_WWDT0_CLKDIV to value 0"]
impl crate::Resettable for MrccWwdt0ClkdivSpec {}
